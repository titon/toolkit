...
(function($) {
    ...
    Component._errorTemplate = function() {
        return $('<div/>')
            .addClass(Toolkit.options.vendor + $.hyphenate(this.component.toLowerCase()) + '-error')
    ...
    Component._loadingTemplate = function() {
        return $('<div/>')
            .addClass(Toolkit.options.vendor + $.hyphenate(this.component.toLowerCase()) + '-loading')
