...
<div class="example">
    ...
    <div class="grid">
        ...
        <div class="col desktop-6 tablet-6">
            ...
            <div class="intro">
                <h4>Why are these examples so ugly?</h4>

                <p>All theses examples are used purely for testing each component, their configurations, styles, different vendors, themes, what have you. They are literally a part of the project repository.</p>

                <p>A fully fledged website with documentation, APIs, and examples is in the works. But I need a demo currently, so these examples will suffice for the time being.</p>
            </div>
