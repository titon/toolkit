...
Internet Explorer 8 has also been dropped. If IE8 support is required, please use Toolkit 1.x.
...
have been packaged into individual JS files with their own dependencies. This greatly improved efficiency, 
made it easier to maintain, reduced the output file size, and allowed custom builds to only require the necessary dependencies.
...
The major issues we had in 1.x was components getting confused between the parent and child when binding events 
